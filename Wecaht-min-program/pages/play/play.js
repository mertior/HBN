...
Page({
  ...
  onPlay(songList,songCount) {
    ...
    let imgSrc = 'https://musicbucket-1306354408.cos.ap-chengdu.myqcloud.com/Album%2F' + songList.AlbumId + '.jpg';
    ...
    playRequest(songList.songmid).then(data => {
      ...
      console.log('https://musicbucket-1306354408.cos.ap-chengdu.myqcloud.com/Music%2F' + songList.Songmid + '.mp3');
      
      andio.src = 'https://musicbucket-1306354408.cos.ap-chengdu.myqcloud.com/Music%2F' + songList.Songmid + '.mp3';
  ...
  onLast() {
    ...
    let songList = getApp().globalData.songList[songCount];
    this.onPlay(songList,songCount);
  },
  onNext() {
    let songCount = getApp().globalData.songCount;
